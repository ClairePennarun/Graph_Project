...
public class VoisinagePickNDrop implements Voisinage {
	...
	public void bestSolVoisine(Graphe g) {
		...
		// On cherche sa classe pour être sur de le pickNdroper dans une nouvelle
		...
		// Une fois le voisin optimal trouvé, on change le sommet en question de classe.
