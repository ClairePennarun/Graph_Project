...
public class VoisinageSwap implements Voisinage {
	...
	public void bestSolVoisine(Graphe g) {
		...
		// On choisi alors de changer le sommet 0 et le sommet 1 à swaper
		int sommet1DeSolutionMin = 0;
		int sommet2DeSolutionMin = 1;
		// Puis on cherche de quelle classe il est déjà, pour en choisir une autre
		int evalCourante;
		// Et on initialise evalMin
		int evalMax = g.evalSwap(sommet1DeSolutionMin, sommet2DeSolutionMin);
		
		// Test de tout les couples de voisins possibles
		...
		// Une fois le voisin optimal trouvé, on swap le couple de sommets
